...
The human does not classify risk. The agent does.
...
migration. A health endpoint in a new scaffolded project is smoke proof, not a
public contract escalation by itself.
