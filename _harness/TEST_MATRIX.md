...
| ----- | --------------------------------------- | ---- | ----------- | --- | -------- | ------- | -------- |
| US-001 | Simple curl installer for `harness-engineering` | yes | yes | no | yes | implemented | `cargo test`; `bash -n install.sh`; temp install plus `task start` and `query matrix` |
