...
mod tests {
    ...
    fn scores_minimal_standard_and_detailed_traces() {
        ...
        standard_source.files_changed = Some("[\"_harness/TRACE_SPEC.md\"]".to_owned());
        ...
        detailed_source.files_changed = Some("[\"_harness/TRACE_SPEC.md\"]".to_owned());
    ...
    fn compares_trace_score_to_lane_requirement() {
        ...
        source.files_changed = Some("[\"_harness/TRACE_SPEC.md\"]".to_owned());
