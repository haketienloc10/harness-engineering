...
Harness v0 originally stored operational data in markdown files:
`TEST_MATRIX.md` rows, backlog items, decision records, and story status. This
works for human reading but creates friction for agents:
...
- Add stronger observability reports once the durable layer proves useful.
